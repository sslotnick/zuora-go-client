...
func (a InvoicePaymentsApi) ObjectGETInvoicePayment(id string, entityId string, entityName string, fields string) (*ProxyGetInvoicePayment, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/object/invoice-payment/{id}"
	...
	var successPayload = new(ProxyGetInvoicePayment)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectGETInvoicePayment", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a InvoicePaymentsApi) ObjectPOSTInvoicePayment(createRequest ProxyCreateInvoicePayment, entityId string, entityName string) (*ProxyCreateOrModifyResponse, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/object/invoice-payment"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectPOSTInvoicePayment", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a InvoicePaymentsApi) ObjectPUTInvoicePayment(id string, modifyRequest ProxyModifyInvoicePayment, entityId string, entityName string) (*ProxyCreateOrModifyResponse, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectPUTInvoicePayment", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
