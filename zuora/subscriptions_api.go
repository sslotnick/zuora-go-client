...
func (a SubscriptionsApi) GETSubscriptionsByAccount(accountKey string, entityId string, entityName string, pageSize int32, chargeDetail string) (*GetSubscriptionWrapper, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/subscriptions/accounts/{account-key}"
	...
	localVarQueryParams.Add("charge-detail", a.Configuration.APIClient.ParameterToString(chargeDetail, ""))
	...
	var successPayload = new(GetSubscriptionWrapper)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETSubscriptionsByAccount", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a SubscriptionsApi) GETSubscriptionsByKey(subscriptionKey string, entityId string, entityName string, chargeDetail string) (*GetSubscriptionTypeWithSuccess, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/subscriptions/{subscription-key}"
	localVarPath = strings.Replace(localVarPath, "{"+"subscription-key"+"}", fmt.Sprintf("%v", subscriptionKey), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetSubscriptionTypeWithSuccess)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETSubscriptionsByKey", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) GETSubscriptionsByKeyAndVersion(subscriptionKey string, version string, entityId string, entityName string, chargeDetail string) (*GetSubscriptionTypeWithSuccess, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/subscriptions/{subscription-key}/versions/{version}"
	localVarPath = strings.Replace(localVarPath, "{"+"subscription-key"+"}", fmt.Sprintf("%v", subscriptionKey), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETSubscriptionsByKeyAndVersion", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) ObjectDELETESubscription(id string, entityId string, entityName string) (*ProxyDeleteResponse, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/object/subscription/{id}"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectDELETESubscription", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) ObjectGETSubscription(id string, entityId string, entityName string, fields string) (*ProxyGetSubscription, *APIResponse, error) {
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(ProxyGetSubscription)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectGETSubscription", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) ObjectPUTSubscription(id string, modifyRequest ProxyModifySubscription, entityId string, entityName string) (*ProxyCreateOrModifyResponse, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectPUTSubscription", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) POSTPreviewSubscription(request PostSubscriptionPreviewType, entityId string, entityName string, zuoraVersion string) (*PostSubscriptionPreviewResponseType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/subscriptions/preview"
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	// header params "zuora-version"
	localVarHeaderParams["zuora-version"] = a.Configuration.APIClient.ParameterToString(zuoraVersion, "")
	// body params
	localVarPostBody = &request
	var successPayload = new(PostSubscriptionPreviewResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTPreviewSubscription", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) POSTSubscription(request PostSubscriptionType, entityId string, entityName string, zuoraVersion string) (*PostSubscriptionResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/subscriptions"
	...
	// body params
	localVarPostBody = &request
	var successPayload = new(PostSubscriptionResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTSubscription", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) PUTCancelSubscription(subscriptionKey string, request PostSubscriptionCancellationType, entityId string, entityName string, zuoraVersion string) (*PostSubscriptionCancellationResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/subscriptions/{subscription-key}/cancel"
	localVarPath = strings.Replace(localVarPath, "{"+"subscription-key"+"}", fmt.Sprintf("%v", subscriptionKey), -1)
	...
	// body params
	localVarPostBody = &request
	var successPayload = new(PostSubscriptionCancellationResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTCancelSubscription", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) PUTRenewSubscription(subscriptionKey string, request PutRenewSubscriptionType, entityId string, entityName string, zuoraVersion string) (*PutRenewSubscriptionResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/subscriptions/{subscription-key}/renew"
	localVarPath = strings.Replace(localVarPath, "{"+"subscription-key"+"}", fmt.Sprintf("%v", subscriptionKey), -1)
	...
	// body params
	localVarPostBody = &request
	var successPayload = new(PutRenewSubscriptionResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTRenewSubscription", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) PUTResumeSubscription(subscriptionKey string, request PutSubscriptionResumeType, entityId string, entityName string, zuoraVersion string) (*PutSubscriptionResumeResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/subscriptions/{subscription-key}/resume"
	localVarPath = strings.Replace(localVarPath, "{"+"subscription-key"+"}", fmt.Sprintf("%v", subscriptionKey), -1)
	...
	// body params
	localVarPostBody = &request
	var successPayload = new(PutSubscriptionResumeResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTResumeSubscription", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) PUTSubscription(subscriptionKey string, request PutSubscriptionType, entityId string, entityName string, zuoraVersion string) (*PutSubscriptionResponseType, *APIResponse, error) {
	...
	// body params
	localVarPostBody = &request
	var successPayload = new(PutSubscriptionResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTSubscription", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SubscriptionsApi) PUTSuspendSubscription(subscriptionKey string, request PutSubscriptionSuspendType, entityId string, entityName string, zuoraVersion string) (*PutSubscriptionSuspendResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/subscriptions/{subscription-key}/suspend"
	localVarPath = strings.Replace(localVarPath, "{"+"subscription-key"+"}", fmt.Sprintf("%v", subscriptionKey), -1)
	...
	// body params
	localVarPostBody = &request
	var successPayload = new(PutSubscriptionSuspendResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTSuspendSubscription", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
