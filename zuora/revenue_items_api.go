...
func (a RevenueItemsApi) GETRevenueItemsByChargeRevenueEventNumber(eventNumber string, entityId string, entityName string, pageSize int32) (*GetRevenueItemsType, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/revenue-items/revenue-events/{event-number}"
	localVarPath = strings.Replace(localVarPath, "{"+"event-number"+"}", fmt.Sprintf("%v", eventNumber), -1)
	...
	var successPayload = new(GetRevenueItemsType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETRevenueItemsByChargeRevenueEventNumber", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a RevenueItemsApi) GETRevenueItemsByChargeRevenueSummaryNumber(crsNumber string, entityId string, entityName string, pageSize int32) (*GetRevenueItemsType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-items/charge-revenue-summaries/{crs-number}"
	localVarPath = strings.Replace(localVarPath, "{"+"crs-number"+"}", fmt.Sprintf("%v", crsNumber), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETRevenueItemsByChargeRevenueSummaryNumber", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueItemsApi) GETRevenueItemsByRevenueSchedule(rsNumber string, entityId string, entityName string, pageSize int32) (*GetRsRevenueItemsType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-items/revenue-schedules/{rs-number}"
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetRsRevenueItemsType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETRevenueItemsByRevenueSchedule", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueItemsApi) PUTCustomFieldsonRevenueItemsByRevenueEvent(eventNumber string, request PutEventRiDetailType, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTCustomFieldsonRevenueItemsByRevenueEvent", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueItemsApi) PUTCustomFieldsonRevenueItemsByRevenueSchedule(rsNumber string, request PutScheduleRiDetailType, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTCustomFieldsonRevenueItemsByRevenueSchedule", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
