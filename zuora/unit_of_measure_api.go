...
func (a UnitOfMeasureApi) ObjectDELETEUnitOfMeasure(id string, entityId string, entityName string) (*ProxyDeleteResponse, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/object/unit-of-measure/{id}"
	...
	var localVarAPIResponse = &APIResponse{Operation: "ObjectDELETEUnitOfMeasure", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a UnitOfMeasureApi) ObjectGETUnitOfMeasure(id string, entityId string, entityName string, fields string) (*ProxyGetUnitOfMeasure, *APIResponse, error) {
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(ProxyGetUnitOfMeasure)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectGETUnitOfMeasure", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a UnitOfMeasureApi) ObjectPOSTUnitOfMeasure(createRequest ProxyCreateUnitOfMeasure, entityId string, entityName string) (*ProxyCreateOrModifyResponse, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/object/unit-of-measure"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectPOSTUnitOfMeasure", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a UnitOfMeasureApi) ObjectPUTUnitOfMeasure(id string, modifyRequest ProxyModifyUnitOfMeasure, entityId string, entityName string) (*ProxyCreateOrModifyResponse, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectPUTUnitOfMeasure", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
