...
func (a CreditMemosApi) DELETECreditMemo(creditMemoId string, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}"
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	var localVarAPIResponse = &APIResponse{Operation: "DELETECreditMemo", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a CreditMemosApi) GETCreditMemo(creditMemoId string, entityId string, entityName string) (*GetCreditMemoType, *APIResponse, error) {
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetCreditMemoType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETCreditMemo", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) GETCreditMemoItem(cmitemid string, creditMemoId string, entityId string, entityName string) (*GetCreditMemoItemType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/items/{cmitemid}"
	localVarPath = strings.Replace(localVarPath, "{"+"cmitemid"+"}", fmt.Sprintf("%v", cmitemid), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetCreditMemoItemType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETCreditMemoItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) GETCreditMemoItemPart(partid string, itempartid string, creditMemoId string, entityId string, entityName string) (*GetCreditMemoItemPartType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/parts/{partid}/itemparts/{itempartid}"
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetCreditMemoItemPartType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETCreditMemoItemPart", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) GETCreditMemoItemParts(partid string, creditMemoId string, entityId string, entityName string, pageSize int32) (*GetCreditMemoItemPartsCollectionType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/parts/{partid}/itemparts"
	localVarPath = strings.Replace(localVarPath, "{"+"partid"+"}", fmt.Sprintf("%v", partid), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetCreditMemoItemPartsCollectionType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETCreditMemoItemParts", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) GETCreditMemoItems(creditMemoId string, entityId string, entityName string, pageSize int32, fieldsFilterable string, sort string) (*GetCreditMemoItemsListType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/items"
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetCreditMemoItemsListType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETCreditMemoItems", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) GETCreditMemoPart(partid string, creditMemoId string, entityId string, entityName string) (*GetCreditMemoPartType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/parts/{partid}"
	localVarPath = strings.Replace(localVarPath, "{"+"partid"+"}", fmt.Sprintf("%v", partid), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetCreditMemoPartType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETCreditMemoPart", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) GETCreditMemoParts(creditMemoId string, entityId string, entityName string, pageSize int32) (*GetCreditMemoPartsCollectionType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/parts"
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetCreditMemoPartsCollectionType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETCreditMemoParts", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) GETCreditMemos(entityId string, entityName string, pageSize int32, fieldsFilterable string, sort string) (*GetCreditMemoCollectionType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos"
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetCreditMemoCollectionType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETCreditMemos", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) POSTApplyCreditMemo(body ApplyCreditMemoType, creditMemoId string, entityId string, entityName string) (*GetCreditMemoType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/apply"
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTApplyCreditMemo", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) POSTCancelCreditMemo(creditMemoId string, entityId string, entityName string) (*GetCreditMemoType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/cancel"
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTCancelCreditMemo", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) POSTCreditMemoFromInvoice(body CreditMemoFromInvoiceType, invoiceId string, entityId string, entityName string) (*GetCreditMemoType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/invoice/{invoiceId}"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTCreditMemoFromInvoice", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) POSTCreditMemoFromPrpc(body CreditMemoFromChargeType, entityId string, entityName string) (*GetCreditMemoType, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTCreditMemoFromPrpc", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) POSTCreditMemoPDF(creditMemoId string, entityId string, entityName string) (*PostMemoPdfResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/pdfs"
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(PostMemoPdfResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTCreditMemoPDF", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) POSTEmailCreidtMemo(request PostCreditMemoEmailRequestType, creditMemoId string, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/emails"
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTEmailCreidtMemo", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) POSTPostCreditMemo(creditMemoId string, entityId string, entityName string) (*GetCreditMemoType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/post"
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTPostCreditMemo", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) POSTQueryCreditMemos(body CreditMemoQueryType, entityId string, entityName string, pageSize int32) (*GetCreditMemoCollectionType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/query"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTQueryCreditMemos", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) POSTRefundCreditMemo(body PostNonRefRefundType, creditmemoId string, entityId string, entityName string) (*GetRefundCreditMemoType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditmemoId}/refund"
	localVarPath = strings.Replace(localVarPath, "{"+"creditmemoId"+"}", fmt.Sprintf("%v", creditmemoId), -1)
	...
	// body params
	localVarPostBody = &body
	var successPayload = new(GetRefundCreditMemoType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTRefundCreditMemo", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) POSTUnapplyCreditMemo(body UnapplyCreditMemoType, creditMemoId string, entityId string, entityName string) (*GetCreditMemoType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/creditmemos/{creditMemoId}/unapply"
	localVarPath = strings.Replace(localVarPath, "{"+"creditMemoId"+"}", fmt.Sprintf("%v", creditMemoId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTUnapplyCreditMemo", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a CreditMemosApi) PUTUpdateCreditMemo(body PutCreditMemoType, creditMemoId string, entityId string, entityName string) (*GetCreditMemoType, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTUpdateCreditMemo", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
