...
func (a MassUpdaterApi) GETMassUpdater(bulkKey string, entityId string, entityName string) (*GetMassUpdateType, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/bulk/{bulk-key}"
	localVarPath = strings.Replace(localVarPath, "{"+"bulk-key"+"}", fmt.Sprintf("%v", bulkKey), -1)
	...
	var successPayload = new(GetMassUpdateType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETMassUpdater", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a MassUpdaterApi) POSTMassUpdater(contentType string, request PostMassUpdateType, entityId string, entityName string) (*PostMassUpdateResponseType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/bulk"
	...
	var successPayload = new(PostMassUpdateResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTMassUpdater", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a MassUpdaterApi) PUTMassUpdater(bulkKey string, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/bulk/{bulk-key}/stop"
	localVarPath = strings.Replace(localVarPath, "{"+"bulk-key"+"}", fmt.Sprintf("%v", bulkKey), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTMassUpdater", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
