...
func (a TaxationItemsApi) DELETETaxationItem(id string, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/taxationitems/{id}"
	...
	var localVarAPIResponse = &APIResponse{Operation: "DELETETaxationItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a TaxationItemsApi) GETTaxationItem(id string, entityId string, entityName string) (*GetTaxationItemType, *APIResponse, error) {
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetTaxationItemType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETTaxationItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a TaxationItemsApi) ObjectDELETETaxationItem(id string, entityId string, entityName string) (*ProxyDeleteResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Delete")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/object/taxation-item/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectDELETETaxationItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a TaxationItemsApi) ObjectGETTaxationItem(id string, entityId string, entityName string, fields string) (*ProxyGetTaxationItem, *APIResponse, error) {
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(ProxyGetTaxationItem)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectGETTaxationItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a TaxationItemsApi) ObjectPOSTTaxationItem(createRequest ProxyCreateTaxationItem, entityId string, entityName string) (*ProxyCreateOrModifyResponse, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/object/taxation-item"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectPOSTTaxationItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a TaxationItemsApi) ObjectPUTTaxationItem(id string, modifyRequest ProxyModifyTaxationItem, entityId string, entityName string) (*ProxyCreateOrModifyResponse, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectPUTTaxationItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a TaxationItemsApi) POSTCMTaxationItems(memoId string, body PostTaxationItemListForCmType, entityId string, entityName string) (*GetTaxationItemListType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/taxationitems/creditmemo/{memoId}"
	localVarPath = strings.Replace(localVarPath, "{"+"memoId"+"}", fmt.Sprintf("%v", memoId), -1)
	...
	var successPayload = new(GetTaxationItemListType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTCMTaxationItems", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a TaxationItemsApi) POSTDMTaxationItems(memoId string, body PostTaxationItemListForDmType, entityId string, entityName string) (*GetTaxationItemListType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/taxationitems/debitmemo/{memoId}"
	localVarPath = strings.Replace(localVarPath, "{"+"memoId"+"}", fmt.Sprintf("%v", memoId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTDMTaxationItems", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a TaxationItemsApi) PUTTaxationItem(body PutTaxationItemType, id string, entityId string, entityName string) (*GetTaxationItemType, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTTaxationItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
