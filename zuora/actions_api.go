...
func (a ActionsApi) ActionPOSTamend(amendRequest ProxyActionamendRequest, entityId string, entityName string) (*ProxyActionamendResponse, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/action/amend"
	...
	// body params
	localVarPostBody = &amendRequest
	var successPayload = new(ProxyActionamendResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ActionPOSTamend", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a ActionsApi) ActionPOSTcreate(createRequest ProxyActioncreateRequest, entityId string, entityName string) (*ProxyActioncreateResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/action/create"
	...
	var successPayload = new(ProxyActioncreateResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ActionPOSTcreate", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a ActionsApi) ActionPOSTdelete(deleteRequest ProxyActiondeleteRequest, entityId string, entityName string) (*ProxyActiondeleteResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/action/delete"
	...
	var successPayload = new(ProxyActiondeleteResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ActionPOSTdelete", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a ActionsApi) ActionPOSTexecute(executeRequest ProxyActionexecuteRequest, entityId string, entityName string) (*ProxyActionexecuteResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/action/execute"
	...
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	// body params
	localVarPostBody = &executeRequest
	var successPayload = new(ProxyActionexecuteResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ActionPOSTexecute", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a ActionsApi) ActionPOSTgenerate(generateRequest ProxyActiongenerateRequest, entityId string, entityName string) (*ProxyActiongenerateResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/action/generate"
	...
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	// body params
	localVarPostBody = &generateRequest
	var successPayload = new(ProxyActiongenerateResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ActionPOSTgenerate", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a ActionsApi) ActionPOSTquery(queryRequest ProxyActionqueryRequest, entityId string, entityName string) (*ProxyActionqueryResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/action/query"
	...
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	// body params
	localVarPostBody = &queryRequest
	var successPayload = new(ProxyActionqueryResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ActionPOSTquery", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a ActionsApi) ActionPOSTqueryMore(queryMoreRequest ProxyActionqueryMoreRequest, entityId string, entityName string) (*ProxyActionqueryMoreResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/action/queryMore"
	...
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	// body params
	localVarPostBody = &queryMoreRequest
	var successPayload = new(ProxyActionqueryMoreResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ActionPOSTqueryMore", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a ActionsApi) ActionPOSTsubscribe(subscribeRequest ProxyActionsubscribeRequest, entityId string, entityName string) (*ProxyActionsubscribeResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/action/subscribe"
	...
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	// body params
	localVarPostBody = &subscribeRequest
	var successPayload = new(ProxyActionsubscribeResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ActionPOSTsubscribe", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a ActionsApi) ActionPOSTupdate(updateRequest ProxyActionupdateRequest, entityId string, entityName string) (*ProxyActionupdateResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/action/update"
	...
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	// body params
	localVarPostBody = &updateRequest
	var successPayload = new(ProxyActionupdateResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ActionPOSTupdate", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
