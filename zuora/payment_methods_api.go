...
func (a PaymentMethodsApi) DELETEPaymentMethods(paymentMethodId string, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/payment-methods/{payment-method-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"payment-method-id"+"}", fmt.Sprintf("%v", paymentMethodId), -1)
	...
	var localVarAPIResponse = &APIResponse{Operation: "DELETEPaymentMethods", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a PaymentMethodsApi) GETPaymentMethods(accountKey string, entityId string, entityName string, pageSize int32) (*GetPaymentMethodsType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/payment-methods/credit-cards/accounts/{account-key}"
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetPaymentMethodsType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
...
func (a PaymentMethodsApi) ObjectDELETEPaymentMethod(id string, entityId string, entityName string) (*ProxyDeleteResponse, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Delete")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/object/payment-method/{id}"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectDELETEPaymentMethod", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a PaymentMethodsApi) ObjectGETPaymentMethod(id string, entityId string, entityName string, fields string) (*ProxyGetPaymentMethod, *APIResponse, error) {
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(ProxyGetPaymentMethod)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectGETPaymentMethod", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a PaymentMethodsApi) ObjectPOSTPaymentMethod(createRequest ProxyCreatePaymentMethod, entityId string, entityName string) (*ProxyCreateOrModifyResponse, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/object/payment-method"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectPOSTPaymentMethod", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a PaymentMethodsApi) ObjectPUTPaymentMethod(id string, modifyRequest ProxyModifyPaymentMethod, entityId string, entityName string) (*ProxyCreateOrModifyResponse, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ObjectPUTPaymentMethod", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a PaymentMethodsApi) POSTPaymentMethods(request PostPaymentMethodType, entityId string, entityName string) (*PostPaymentMethodResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/payment-methods/credit-cards"
	...
	var successPayload = new(PostPaymentMethodResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTPaymentMethods", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a PaymentMethodsApi) POSTPaymentMethodsDecryption(request PostPaymentMethodDecryption, entityId string, entityName string) (*PostPaymentMethodResponseDecryption, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/payment-methods/decryption"
	...
	// body params
	localVarPostBody = &request
	var successPayload = new(PostPaymentMethodResponseDecryption)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTPaymentMethodsDecryption", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a PaymentMethodsApi) PUTPaymentMethods(paymentMethodId string, request PutPaymentMethodType, entityId string, entityName string) (*PutPaymentMethodResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/payment-methods/credit-cards/{payment-method-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"payment-method-id"+"}", fmt.Sprintf("%v", paymentMethodId), -1)
	...
	// body params
	localVarPostBody = &request
	var successPayload = new(PutPaymentMethodResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTPaymentMethods", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
