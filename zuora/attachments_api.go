...
func (a AttachmentsApi) DELETEAttachments(attachmentId string, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/attachments/{attachment-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"attachment-id"+"}", fmt.Sprintf("%v", attachmentId), -1)
	...
	var localVarAPIResponse = &APIResponse{Operation: "DELETEAttachments", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a AttachmentsApi) GETAttachments(attachmentId string, entityId string, entityName string) (*GetAttachmentResponseType, *APIResponse, error) {
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetAttachmentResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETAttachments", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a AttachmentsApi) GETAttachmentsList(objectType string, objectKey string, entityId string, entityName string, pageSize int32) (*GetAttachmentsResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/attachments/{object-type}/{object-key}"
	localVarPath = strings.Replace(localVarPath, "{"+"object-type"+"}", fmt.Sprintf("%v", objectType), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"object-key"+"}", fmt.Sprintf("%v", objectKey), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetAttachmentsResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETAttachmentsList", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a AttachmentsApi) POSTAttachments(associatedObjectType string, associatedObjectKey string, request PostAttachmentType, entityId string, entityName string, description string) (*PostAttachmentResponseType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/attachments"
	...
	localVarQueryParams.Add("associatedObjectType", a.Configuration.APIClient.ParameterToString(associatedObjectType, ""))
	localVarQueryParams.Add("associatedObjectKey", a.Configuration.APIClient.ParameterToString(associatedObjectKey, ""))
	...
	var successPayload = new(PostAttachmentResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTAttachments", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a AttachmentsApi) PUTAttachments(attachmentId string, entityId string, entityName string, request PutAttachmentType) (*CommonResponseType, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTAttachments", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
