...
func (a RevenueSchedulesApi) DELETERS(rsNumber string, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/{rs-number}"
	localVarPath = strings.Replace(localVarPath, "{"+"rs-number"+"}", fmt.Sprintf("%v", rsNumber), -1)
	...
	var localVarAPIResponse = &APIResponse{Operation: "DELETERS", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a RevenueSchedulesApi) GETRS(rsNumber string, entityId string, entityName string) (*GetrsDetailType, *APIResponse, error) {
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetrsDetailType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETRS", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) GETRSbyCreditMemoItem(cmiId string) (*GetrsDetailType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/credit-memo-items/{cmi-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"cmi-id"+"}", fmt.Sprintf("%v", cmiId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETRSbyCreditMemoItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) GETRSbyDebitMemoItem(dmiId string) (*GetrsDetailType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/debit-memo-items/{dmi-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"dmi-id"+"}", fmt.Sprintf("%v", dmiId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETRSbyDebitMemoItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) GETRSbyInvoiceItem(invoiceItemId string, entityId string, entityName string) (*GetrsDetailType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/invoice-items/{invoice-item-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"invoice-item-id"+"}", fmt.Sprintf("%v", invoiceItemId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETRSbyInvoiceItem", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) GETRSbyInvoiceItemAdjustment(invoiceItemAdjId string, entityId string, entityName string) (*GetrsDetailType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/invoice-item-adjustments/{invoice-item-adj-id}/"
	localVarPath = strings.Replace(localVarPath, "{"+"invoice-item-adj-id"+"}", fmt.Sprintf("%v", invoiceItemAdjId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETRSbyInvoiceItemAdjustment", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) GETRSbyProductChargeAndBillingAccount(accountKey string, chargeKey string, pageSize int32) (*GetrsDetailsByProductChargeType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/product-charges/{charge-key}/{account-key}"
	localVarPath = strings.Replace(localVarPath, "{"+"account-key"+"}", fmt.Sprintf("%v", accountKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"charge-key"+"}", fmt.Sprintf("%v", chargeKey), -1)
	...
	var successPayload = new(GetrsDetailsByProductChargeType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETRSbyProductChargeAndBillingAccount", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) GETRSforSubscCharge(chargeKey string, entityId string, entityName string, pageSize int32) (*GetrsDetailsByChargeType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/subscription-charges/{charge-key}"
	localVarPath = strings.Replace(localVarPath, "{"+"charge-key"+"}", fmt.Sprintf("%v", chargeKey), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetrsDetailsByChargeType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETRSforSubscCharge", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) POSTRSforCrditMemoItemManualDistribution(cmiId string, body PostRevenueScheduleByTransactionType) (*PostRevenueScheduleByTransactionResponseType, *APIResponse, error) {
	...
	var successPayload = new(PostRevenueScheduleByTransactionResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTRSforCrditMemoItemManualDistribution", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) POSTRSforCreditMemoItemDistributeByDateRange(cmiId string, body PostRevenueScheduleByTransactionRatablyType) (*PostRevenueScheduleByTransactionResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/credit-memo-items/{cmi-id}/distribute-revenue-with-date-range"
	localVarPath = strings.Replace(localVarPath, "{"+"cmi-id"+"}", fmt.Sprintf("%v", cmiId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTRSforCreditMemoItemDistributeByDateRange", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) POSTRSforDebitMemoItemDistributeByDateRange(dmiId string, body PostRevenueScheduleByTransactionRatablyType) (*PostRevenueScheduleByTransactionResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/debit-memo-items/{dmi-id}/distribute-revenue-with-date-range"
	localVarPath = strings.Replace(localVarPath, "{"+"dmi-id"+"}", fmt.Sprintf("%v", dmiId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTRSforDebitMemoItemDistributeByDateRange", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) POSTRSforDebitMemoItemManualDistribution(dmiId string, body PostRevenueScheduleByTransactionType) (*PostRevenueScheduleByTransactionResponseType, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTRSforDebitMemoItemManualDistribution", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) POSTRSforInvoiceItemAdjustmentDistributeByDateRange(invoiceItemAdjKey string, request PostRevenueScheduleByDateRangeType, entityId string, entityName string) (*PostRevenueScheduleByTransactionResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/invoice-item-adjustments/{invoice-item-adj-key}/distribute-revenue-with-date-range"
	localVarPath = strings.Replace(localVarPath, "{"+"invoice-item-adj-key"+"}", fmt.Sprintf("%v", invoiceItemAdjKey), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTRSforInvoiceItemAdjustmentDistributeByDateRange", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) POSTRSforInvoiceItemAdjustmentManualDistribution(invoiceItemAdjKey string, request PostRevenueScheduleByTransactionType, entityId string, entityName string) (*PostRevenueScheduleByTransactionResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/invoice-item-adjustments/{invoice-item-adj-key}"
	localVarPath = strings.Replace(localVarPath, "{"+"invoice-item-adj-key"+"}", fmt.Sprintf("%v", invoiceItemAdjKey), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTRSforInvoiceItemAdjustmentManualDistribution", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) POSTRSforInvoiceItemDistributeByDateRange(invoiceItemId string, request PostRevenueScheduleByDateRangeType, entityId string, entityName string) (*PostRevenueScheduleByTransactionResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/invoice-items/{invoice-item-id}/distribute-revenue-with-date-range"
	localVarPath = strings.Replace(localVarPath, "{"+"invoice-item-id"+"}", fmt.Sprintf("%v", invoiceItemId), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTRSforInvoiceItemDistributeByDateRange", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) POSTRSforInvoiceItemManualDistribution(invoiceItemId string, request PostRevenueScheduleByTransactionType, entityId string, entityName string) (*PostRevenueScheduleByTransactionResponseType, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTRSforInvoiceItemManualDistribution", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) POSTRSforSubsCharge(chargeKey string, request PostRevenueScheduleByChargeType, entityId string, entityName string) (*PostRevenueScheduleByChargeResponseType, *APIResponse, error) {
	...
	// body params
	localVarPostBody = &request
	var successPayload = new(PostRevenueScheduleByChargeResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTRSforSubsCharge", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) PUTRSBasicInfo(rsNumber string, request PutrsBasicInfoType, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/{rs-number}/basic-information"
	localVarPath = strings.Replace(localVarPath, "{"+"rs-number"+"}", fmt.Sprintf("%v", rsNumber), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTRSBasicInfo", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) PUTRevenueAcrossAP(rsNumber string, request PutAllocateManuallyType, entityId string, entityName string) (*PutRevenueScheduleResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/{rs-number}/distribute-revenue-across-accounting-periods"
	localVarPath = strings.Replace(localVarPath, "{"+"rs-number"+"}", fmt.Sprintf("%v", rsNumber), -1)
	...
	// body params
	localVarPostBody = &request
	var successPayload = new(PutRevenueScheduleResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTRevenueAcrossAP", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) PUTRevenueByRecognitionStartandEndDates(rsNumber string, request PutrsTermType, entityId string, entityName string) (*PutRevenueScheduleResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/{rs-number}/distribute-revenue-with-date-range"
	localVarPath = strings.Replace(localVarPath, "{"+"rs-number"+"}", fmt.Sprintf("%v", rsNumber), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTRevenueByRecognitionStartandEndDates", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a RevenueSchedulesApi) PUTRevenueSpecificDate(rsNumber string, request PutSpecificDateAllocationType, entityId string, entityName string) (*PutRevenueScheduleResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/revenue-schedules/{rs-number}/distribute-revenue-on-specific-date"
	localVarPath = strings.Replace(localVarPath, "{"+"rs-number"+"}", fmt.Sprintf("%v", rsNumber), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTRevenueSpecificDate", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
