...
func NewSummaryJournalEntriesApi() *SummaryJournalEntriesApi {
	...
	return &SummaryJournalEntriesApi{
		Configuration: configuration,
	}
}
...
func (a SummaryJournalEntriesApi) DELETESummaryJournalEntry(jeNumber string, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/journal-entries/{je-number}"
	localVarPath = strings.Replace(localVarPath, "{"+"je-number"+"}", fmt.Sprintf("%v", jeNumber), -1)
	...
	var localVarAPIResponse = &APIResponse{Operation: "DELETESummaryJournalEntry", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a SummaryJournalEntriesApi) GETAllSummaryJournalEntries(jrNumber string, entityId string, entityName string, pageSize int32) (*GetJournalEntriesInJournalRunType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/journal-entries/journal-runs/{jr-number}"
	localVarPath = strings.Replace(localVarPath, "{"+"jr-number"+"}", fmt.Sprintf("%v", jrNumber), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetJournalEntriesInJournalRunType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETAllSummaryJournalEntries", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SummaryJournalEntriesApi) GETSummaryJournalEntry(jeNumber string, entityId string, entityName string) (*GetJournalEntryDetailType, *APIResponse, error) {
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(GetJournalEntryDetailType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETSummaryJournalEntry", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SummaryJournalEntriesApi) POSTSummaryJournalEntry(request PostJournalEntryType, entityId string, entityName string) (*PostJournalEntryResponseType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/journal-entries"
	...
	var successPayload = new(PostJournalEntryResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTSummaryJournalEntry", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SummaryJournalEntriesApi) PUTBasicSummaryJournalEntry(jeNumber string, request PutBasicSummaryJournalEntryType, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/journal-entries/{je-number}/basic-information"
	localVarPath = strings.Replace(localVarPath, "{"+"je-number"+"}", fmt.Sprintf("%v", jeNumber), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTBasicSummaryJournalEntry", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a SummaryJournalEntriesApi) PUTSummaryJournalEntry(jeNumber string, entityId string, entityName string) (*CommonResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/journal-entries/{je-number}/cancel"
	localVarPath = strings.Replace(localVarPath, "{"+"je-number"+"}", fmt.Sprintf("%v", jeNumber), -1)
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTSummaryJournalEntry", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
