...
func (a EntityConnectionsApi) GETEntityConnections(entityId string, entityName string, pageSize int32, type_ string) (*GetEntityConnectionsResponseType, *APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v1/entity-connections"
	...
	var successPayload = new(GetEntityConnectionsResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GETEntityConnections", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a EntityConnectionsApi) POSTEntityConnections(entityId string, entityName string, request PostEntityConnectionsType) (*PostEntityConnectionsResponseType, *APIResponse, error) {
	...
	var successPayload = new(PostEntityConnectionsResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "POSTEntityConnections", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a EntityConnectionsApi) PUTEntityConnectionsAccept(connectionId string, entityId string, entityName string) (*PutEntityConnectionsAcceptResponseType, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/entity-connections/{connection-id}/accept"
	localVarPath = strings.Replace(localVarPath, "{"+"connection-id"+"}", fmt.Sprintf("%v", connectionId), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(PutEntityConnectionsAcceptResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTEntityConnectionsAccept", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a EntityConnectionsApi) PUTEntityConnectionsDeny(connectionId string, entityId string, entityName string) (*PutEntityConnectionsDenyResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/entity-connections/{connection-id}/deny"
	localVarPath = strings.Replace(localVarPath, "{"+"connection-id"+"}", fmt.Sprintf("%v", connectionId), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(PutEntityConnectionsDenyResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTEntityConnectionsDeny", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a EntityConnectionsApi) PUTEntityConnectionsDisconnect(connectionId string, entityId string, entityName string) (*PutEntityConnectionsDisconnectResponseType, *APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Put")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/entity-connections/{connection-id}/disconnect"
	localVarPath = strings.Replace(localVarPath, "{"+"connection-id"+"}", fmt.Sprintf("%v", connectionId), -1)
	...
	// header params "entityName"
	localVarHeaderParams["entityName"] = a.Configuration.APIClient.ParameterToString(entityName, "")
	var successPayload = new(PutEntityConnectionsDisconnectResponseType)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "PUTEntityConnectionsDisconnect", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
