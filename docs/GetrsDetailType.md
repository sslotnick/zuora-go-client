...
**UpdatedOn** | [**time.Time**](time.Time.md) | The date and time when the revenue automation start date was set, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; formst.  | [optional] [default to null]
