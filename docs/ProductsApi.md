...
# **ObjectDELETEProduct**
> ProxyDeleteResponse ObjectDELETEProduct($id, $entityId, $entityName)
...
# **ObjectGETProduct**
> ProxyGetProduct ObjectGETProduct($id, $entityId, $entityName, $fields)
...
# **ObjectPOSTProduct**
> ProxyCreateOrModifyResponse ObjectPOSTProduct($createRequest, $entityId, $entityName)
...
# **ObjectPUTProduct**
> ProxyCreateOrModifyResponse ObjectPUTProduct($id, $modifyRequest, $entityId, $entityName)
